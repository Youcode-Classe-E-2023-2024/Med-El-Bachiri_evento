<!-- component -->
<footer class="relative py-20 flex flex-col items-center bg-red-900 overflow-hidden md:py-40">
        ...
        <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                ...
                <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                    <span class="block text-gray-300">Elevate your experiences with Evento. Let's redefine celebration together!</span>

                    <span class="block text-gray-300">Evento &copy; 2021</span>
